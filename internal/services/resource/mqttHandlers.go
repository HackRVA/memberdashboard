...
//  to the resource
func (rm *Resource) HealthCheck(client mqtt.Client, msg mqtt.Message) {
	fmt.Printf("MSG: %s\n", msg.Payload())
...
func (rm *Resource) OnAccessEvent(client mqtt.Client, msg mqtt.Message) {
...
func (rm *Resource) OnHeartBeat(client mqtt.Client, msg mqtt.Message) {
	var hb HeartBeat
...
func (rm *Resource) OnRemoveInvalidRequest(client mqtt.Client, msg mqtt.Message) {
