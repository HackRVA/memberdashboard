...
CREATE SEQUENCE IF NOT EXISTS membership.member_resource_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS membership.member_statuses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS membership.members_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS membership.resources_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE ONLY membership.members
    ADD CONSTRAINT member_tier_id FOREIGN KEY (id) REFERENCES membership.member_tiers(id) NOT VALID;
